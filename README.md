...
## 입지분석 절차 및 방법
1단계 : 시니어센터가 위치할 지역이나 지구를 결정
2단계 : 설정된 지역이나 지구 내에서 시니어센터가 위치할 만한 특정 지점을 선정하고 분석함

이러한 절차를 거치는 이유는 먼저 넓은 지역을 선정하고 점차 범위를 좁혀 나감으로써 점포위치를 구체화하려는 뜻
