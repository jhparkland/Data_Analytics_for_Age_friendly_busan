...
## 요구사항
- 프로젝트의 주제를 명확히 이해하고 아이디어 제시.
- 다양한 사례와 비교하며 부산과 타 지역의 차이점 알기.
- 참고 자료 등 체계적인 분류 밎 관리
- 의견 종합 체계 확립

## 기술적 요구사항
- 코드 간결화(Pandas 메서드 활용  등)
...
>>>>>>> 1117369e3c0702df74be72f8ffe33c1fb35073de
...
## [License](https://github.com/pwjdgus/Data_Analytics_for_Age_friendly_busan/blob/main/LICENSE)
MIT License

Copyright (c) 2022 jhPark
